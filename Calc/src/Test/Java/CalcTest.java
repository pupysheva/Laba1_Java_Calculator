...
public class CalcTest {
	...
	public void test_div(int a, int b) {
		if (Calc.div(4, 2) == 2)
			System.out.println("��");
		else System.out.println("not ��");
	}

	public void test_sub(int a, int b) {
		if (Calc.sub(3, 1) == 2)
			System.out.println("��");
		else System.out.println("not ��");
	}

	public void test_mult(int a, int b) {
		if (Calc.mult(2, 2) == 4)
			System.out.println("��");
		else System.out.println("not ��");
	...
	public void test_add_doub(double a, double b) {
		if ((Calc.add(1.1, 2.1) - 3.2) < 0.000001)
			System.out.println("��");
		else System.out.println("not ��");
	}

	public void test_div_doub(double a, double b) {
		if ((Calc.div(4.2, 2) - 2.1) < 0.000001)
			System.out.println("��");
		else System.out.println("not ��");
	}

	public void test_sub_doub(double a, double b) {
		if ((Calc.sub(3.3, 1.2) - 2.2) < 0.000001)
			System.out.println("ok");
		else System.out.println("not ok");
	}

	public void test_mult_doub(double a, double b) {
